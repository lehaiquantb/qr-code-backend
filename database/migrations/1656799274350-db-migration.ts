...
export class dbMigration1656799274350 implements MigrationInterface {
    name = 'dbMigration1656799274350'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`qrCode\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`categoryId\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`gender\` enum ('male', 'female', 'other') NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`status\` enum ('waiting_for_approval', 'inactive', 'active') NOT NULL DEFAULT 'waiting_for_approval'`);
        ...
        await queryRunner.query(`ALTER TABLE \`rate\` ADD CONSTRAINT \`FK_fab2aea3fd944f2090161edf5c4\` FOREIGN KEY (\`productId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);

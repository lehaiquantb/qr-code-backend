...
export class dbMigration1658521111196 implements MigrationInterface {
    name = 'dbMigration1658521111196'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`REL_5f331beb514de4f4bdf78eb287\` ON \`provider\``);
